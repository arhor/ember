...
process.stdout.write(
    `${JSON.stringify({ type: "item.completed", item: { type: "agent_message", text: JSON.stringify({ ...report, summary: "Starting controlled work.", artifacts_changed: [], known_effects: [] }) } })}\n`,
);
process.stdout.write(
