...
- If `nvm use` fails, stop immediately and report the failure to the user. Do not investigate, switch Node.js versions, or attempt workarounds unless the user explicitly asks you to.
