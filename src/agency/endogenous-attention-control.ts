...
export type RepeatedCognitionAttentionOutcome =
  | "evaluate"
...
function sameContext(
  occurrence: CognitionOpportunityOccurrence,
  request: RepeatedCognitionAttentionRequest,
): boolean {
  return occurrence.runtime_id === request.runtime_id
...
function sameSnapshot(
  ...
  return sameIds(occurrence.projected_meaning_ids, request.projected_meaning_ids)
