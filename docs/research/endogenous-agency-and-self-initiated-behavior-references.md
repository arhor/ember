...
- OpenAI project: https://openai.com/index/reinforcement-learning-with-prediction-based-rewards/
...
### R13 — Horvitz (1999), mixed-initiative interfaces

Eric Horvitz. **Principles of Mixed-Initiative User Interfaces.** CHI 1999, 159–166.
...
### R16 — Lu et al. (ICLR 2025), Proactive Agent / ProactiveBench
...
### R18 — ProAgent (2025), context-driven proactive assistance

Bufang Yang et al. **ProAgent: Harnessing On-Demand Sensory Contexts for Proactive LLM Agent Systems.** 2025.
...
Yuanbo Tang et al. **ProAgentBench: Evaluating LLM Agents for Proactive Assistance with Real-World Data.** 2026.
...
1. Can a persistent agent reliably distinguish a live durable reason from a stale remembered note?
2. Can it re-surface an unresolved concern without keyword overlap while avoiding repeated stale-motive resurrection?
3. Can it explain the durable reason for self-initiated attention without fabricating a post-hoc rationale?
