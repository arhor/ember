...
| `ai/cognition.ts`                                                                                                           | SDK invocation, tools, output, streaming, failure/evidence translation            | Implemented shared AI execution infrastructure                                                                                | MOVED       | `generateText`, `streamText`, `tool`, `Output.object` | #315a implemented; #316 retains tool-policy consolidation                             |
