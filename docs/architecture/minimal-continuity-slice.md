...
sandboxing beyond this slice. The validator prevents a provider *result* from
...
Selected raw *input* occurrences are retained only for this controlled fixture
